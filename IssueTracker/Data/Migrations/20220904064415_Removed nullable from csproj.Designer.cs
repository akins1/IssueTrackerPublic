...
namespace IssueTracker.Data.Migrations
{
    ...
    [Migration("20220904064415_Removed nullable from csproj")]
    partial class Removednullablefromcsproj
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IssueTracker.Models.IssueTrackerUser", b =>
                {
            ...
            modelBuilder.Entity("IssueTracker.Models.Invite", b =>
                {
                    ...
                    b.HasOne("IssueTracker.Models.IssueTrackerUser", "Invitee")
                        .WithMany()
                        .HasForeignKey("InviteeId");

                    b.HasOne("IssueTracker.Models.IssueTrackerUser", "Inviter")
                        .WithMany()
            ...
            modelBuilder.Entity("IssueTracker.Models.Notification", b =>
                {
                    b.HasOne("IssueTracker.Models.IssueTrackerUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IssueTracker.Models.IssueTrackerUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("IssueTracker.Models.Ticket", b =>
                {
                    b.HasOne("IssueTracker.Models.IssueTrackerUser", "DeveloperUser")
                        .WithMany()
                        .HasForeignKey("DeveloperUserId");

                    b.HasOne("IssueTracker.Models.IssueTrackerUser", "OwnerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("IssueTracker.Models.TicketAttachment", b =>
                {
                    ...
                    b.HasOne("IssueTracker.Models.IssueTrackerUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("IssueTrackerUserProject", b =>
                {
                    b.HasOne("IssueTracker.Models.IssueTrackerUser", null)
                        .WithMany()
