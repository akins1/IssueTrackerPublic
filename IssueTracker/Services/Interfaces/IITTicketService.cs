...
namespace IssueTracker.Services.Interfaces
{
    public interface IITTicketService
    {
        ...
        public Task<IssueTrackerUser> GetTicketDeveloperAsync(int ticketId, int companyId);
        ...
        public Task<TicketAttachment> GetTicketAttachmentByIdAsync(Guid ticketAttachmentId);
