...
namespace IssueTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["UserId"] = new SelectList(_context.IssueTrackerUsers, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,CreatedOn,UserId,Description,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.IssueTrackerUsers, "Id", "Id", ticketAttachment.UserId);
            return View(ticketAttachment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,TicketId,CreatedOn,UserId,Description,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
