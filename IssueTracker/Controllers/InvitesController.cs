...
namespace IssueTracker.Controllers
{
    public class InvitesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Invites.Include(i => i.Company).Include(i => i.Invitee).Include(i => i.Project);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["InviteeId"] = new SelectList(_context.IssueTrackerUsers, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,InviteDate,JoinDate,CompanyToken,CompanyId,ProjectId,InvitorId,InviteeId,InviteeEmail,InviteeFirstName,InviteeLastName,isValid")] Invite invite)
        {
            ...
            ViewData["InviteeId"] = new SelectList(_context.IssueTrackerUsers, "Id", "Id", invite.InviteeId);
