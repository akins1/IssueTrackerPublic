...
namespace IssueTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Comment,CreatedOn,TicketId,UserId")] TicketComment ticketComment)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.IssueTrackerUsers, "Id", "Id", ticketComment.UserId);
            return View(ticketComment);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Comment,CreatedOn,TicketId,UserId")] TicketComment ticketComment)
        {
