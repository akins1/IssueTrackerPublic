...
namespace IssueTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,Property,PreviousValue,CurrentValue,CreatedOn,Description,UserId")] TicketHistory ticketHistory)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.IssueTrackerUsers, "Id", "Id", ticketHistory.UserId);
            return View(ticketHistory);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,Property,PreviousValue,CurrentValue,CreatedOn,Description,UserId")] TicketHistory ticketHistory)
        {
